...
namespace Structures
{
    ...
    public class VoronoiToSystem
    {
        public Vector3 cellPosition;
        public List<GrowthDirection> directions;

        public VoronoiToSystem(Vector3 cell, List<GrowthDirection> directions)
        {
    ...
    public class GrowthDirection
    {
        ...
        public GrowthDirection(Vector3 direction, float angle, float magnitude)
        {
